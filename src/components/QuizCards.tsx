      ...
      <div className="mt-2">
        {chapter.questions.map((question) => {
          ...
          return (
            <div
              key={question.id}
              className={cn("p-3 mt-4 border-4 border-secondary rounded-lg", {
                "border-green-700": questionState[question.id] === true,
                "border-red-700": questionState[question.id] === false,
